...
const (
	...
	GET_CONN_RETURN = "GET_CONN_RETURN"

	GET_BUDDY_LIST        = "GET_BUDDY_LIST" // 获取好友分组列表
	GET_BUDDY_LIST_RETURN = "GET_BUDDY_LIST_RETURN"

	CREATE_SESSION        = "CREATE_SESSION" // 创建会话
	CREATE_SESSION_RETURN = "CREATE_SESSION_RETURN"

	SEND_MSG        = "SEND_MSG"        // 发送消息
	SEND_MSG_RETURN = "SEND_MSG_RETURN" // 发送消息
